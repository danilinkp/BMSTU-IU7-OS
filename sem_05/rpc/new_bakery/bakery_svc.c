...
bakery_prog_1(struct svc_req *rqstp, register SVCXPRT *transp)
{
	...
	union {
		int get_number_proc_1_res;
		long result_proc_1_res;
	} result;
	bool_t retval;
	...
	case REGISTER_PROC:
		...
		local = (bool_t (*) (char *, void *,  struct svc_req *))register_proc_1_svc;
		break;

	case GET_NUMBER_PROC:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_int;
		local = (bool_t (*) (char *, void *,  struct svc_req *))get_number_proc_1_svc;
		break;

	case RESULT_PROC:
		_xdr_argument = (xdrproc_t) xdr_int;
		_xdr_result = (xdrproc_t) xdr_long;
		local = (bool_t (*) (char *, void *,  struct svc_req *))result_proc_1_svc;
		break;
